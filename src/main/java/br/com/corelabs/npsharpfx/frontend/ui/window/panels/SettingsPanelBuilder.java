...
public class SettingsPanelBuilder {
    ...
    public javafx.scene.Node buildSettingsPanel(
        ...
        content.getChildren().addAll(
                ...
                createSettingsMenuItem("Themes", "Escolher", onThemesClick),
                new Separator(),
                createSettingsMenuItem("Backup and Sync Settings..."),
                new Separator(),
                createSettingsMenuItem("Wallpapers", "Escolher", onWallpaperClick),
                createSettingsMenuItem("Remover Wallpaper", null, onRemoveWallpaperClick),
    ...
    private Button createSettingsMenuItem(String text) {
        return createSettingsMenuItem(text, null);
    }
    ...
    public javafx.scene.Node buildPlaceholderPanel(String title, String message) {
        VBox content = new VBox();
