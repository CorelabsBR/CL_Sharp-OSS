...
[![NPSharp Constructor](https://github.com/GirelliDev/NPSharp/actions/workflows/pr.yml/badge.svg)](https://github.com/GirelliDev/NPSharp/actions/workflows/autochecker.yml)



[Notepad Sharp](https://npsharp.corelabs.dev.br) é distribuido por uma [Licença Corelabs Padrão](https://npsharp.corelabs.dev.br/license/)

[Notepad Sharp](https://npsharp.corelabs.dev.br) reúne tudo o que o Visual Studio Code oferece — só que sem telemetria, sem coleta escondida, sem travas, e com otimizações feitas por alguém que realmente escreve código todos os dias.
